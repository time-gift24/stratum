...
> **Deprecated**: this document is no longer maintained. The authoritative protocol definition
> is the OpenAPI document generated by utoipa, served at `/api-docs/openapi.json` and browsable
> at `/swagger-ui`.
