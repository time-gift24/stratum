  ...
  return (
    ...
    >
      <div className="relative mx-auto flex h-full w-full max-w-5xl flex-col 2xl:block">
        <Card
          size="sm"
          className="relative mb-6 w-full shrink-0 bg-transparent ring-0 2xl:absolute 2xl:top-1/2 2xl:right-[calc(100%+1.5rem)] 2xl:mb-0 2xl:w-70 2xl:-translate-y-1/2"
        >
