...
export const messages = {
  zh: {
    ...
    "nav.product": "产品",
    "nav.workspace": "工作台",
    "nav.workspace.description": "查看运行时概览与待处理工作。",
    "nav.agents": "智能体",
    "nav.agents.description": "管理智能体配置与状态。",
    "nav.workflows": "工作流",
    "nav.workflows.description": "编排可复用的执行流程。",
    "nav.runs": "运行记录",
    "nav.runs.description": "回顾每次执行的状态与结果。",
    "nav.settings": "设置",
  ...
  en: {
    ...
    "nav.workflows.description": "Compose reusable execution flows.",
    "nav.runs": "Runs",
    "nav.runs.description": "Review the status and result of every execution.",
