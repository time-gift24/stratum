...
export function CenteredNavigation({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(NAV_SURFACE, "flex h-16 items-center rounded-xl px-3")}
        >
            ...
            {groups.map((group) => {
              ...
              return (
                <button
                  key={group.id}
                  type="button"
                  className="inline-flex min-h-11 min-w-28 items-center justify-center gap-1.5 rounded-lg px-4 text-[0.9375rem] font-semibold text-foreground/78 transition-colors duration-200 hover:bg-foreground/6 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none aria-expanded:bg-foreground/7 aria-expanded:text-foreground"
...
function NavigationCard({
  ...
  return (
    <motion.a
      className="group/card flex min-h-18 items-center gap-3 rounded-lg bg-foreground/4 p-3 transition-[background-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:bg-foreground/7 hover:shadow-xl focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
      href={item.href}
