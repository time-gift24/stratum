...
export const glassSurface = cva(
  "relative isolate transform-gpu overflow-hidden border-0 backdrop-blur-2xl backdrop-saturate-125 [backface-visibility:hidden] before:pointer-events-none before:absolute before:inset-0 before:z-0 before:bg-[linear-gradient(145deg,color-mix(in_srgb,var(--foreground)_11%,transparent),transparent_40%,color-mix(in_srgb,var(--foreground)_3%,transparent))] [&>*]:relative [&>*]:z-10",
  {
    variants: {
      ...
      elevation: {
        navigation:
          "shadow-[0_26px_80px_color-mix(in_srgb,var(--background)_70%,transparent),0_10px_32px_color-mix(in_srgb,var(--foreground)_3%,transparent),inset_0_1px_0_color-mix(in_srgb,var(--foreground)_10%,transparent)]",
        composer:
        ...
        overlay:
          "shadow-[0_30px_84px_color-mix(in_srgb,var(--background)_74%,transparent),0_12px_34px_color-mix(in_srgb,var(--foreground)_3%,transparent),inset_0_1px_0_color-mix(in_srgb,var(--foreground)_10%,transparent)]",
