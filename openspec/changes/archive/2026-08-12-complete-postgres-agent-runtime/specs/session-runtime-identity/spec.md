...
- FROM: `### Requirement: Host 提供 Agent runtime context`
- TO: `### Requirement: Host 提供 AgentLoop runtime context`
- FROM: `### Requirement: Agent 持有 Turn 身份`
- TO: `### Requirement: AgentRuntime 持有 Turn 身份`
- FROM: `### Requirement: Agent 可在 Turn 之间修改模型配置`
- TO: `### Requirement: AgentRuntime 可在 Turn 之间修改模型配置`
- FROM: `### Requirement: Agent 历史按 Agent 身份隔离`
- TO: `### Requirement: 对话历史按 AgentRuntimeId 隔离`
